package com.example.thymeleaf.grpc.example.client;

import com.example.thymeleaf.grpc.helloworld.HelloGrpc;
import com.example.thymeleaf.grpc.helloworld.HelloMessage;
...
public class ClientDemo {
    ...
    public void remoteCall(String name) {
        ...
        System.out.println("client 端远程调用 sayHello() 的结果为：\n\n" + response.getMessage());
    }
